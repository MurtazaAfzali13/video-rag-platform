    ...
    <div className="relative flex h-full flex-1 flex-col items-center justify-center overflow-hidden bg-[#050816] px-4 py-8 sm:px-6">
      ...
      <div className="relative z-10 flex w-full max-w-2xl flex-col items-center gap-6 text-center sm:gap-8">
        ...
        <form
          ...
          className="relative flex w-full flex-col gap-4 rounded-2xl border border-slate-700/50 bg-[#08101F] p-3 transition-all duration-300 focus-within:border-purple-500/50 focus-within:shadow-lg focus-within:shadow-purple-500/20 sm:flex-row sm:items-center sm:gap-3 sm:px-4 sm:py-3"
        >
          <div className="flex min-w-0 flex-1 items-center gap-2 px-1 py-1.5 sm:gap-3 sm:py-0">
